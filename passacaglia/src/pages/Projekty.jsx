...
const Projekty = () => {
  return (
    <div>
      ...
      <Banner_podstrona
        image={projektyImg}
        style={{ backgroundPosition: "-0px -362px",
    backgroundSize: "1492px 2070px"}} 
        />
      ...
      <div id="projekty_page">
          ...
          <div id="projekty_aktualne_section">
            <div className="projekty_container_act">
              <div className="projekty_item">
                <div className="projekty_photo" style={{
                backgroundImage: `url(${Jesienimg})`,
                }}><a href="https://example.com" target="_blank" rel="noopener noreferrer" className="projekty_text_link  projekty_text"><h5><i>Jesień z muzyką dawną</i><br/>II edycja</h5></a>
                </div>
              </div>
              <div className="projekty_item">
                <div className="projekty_photo" style={{
              ...
              </div><div className="projekty_item">
                <div className="projekty_photo" style={{
                backgroundImage: `url(${Jesienimg})`,
                }}><a href="https://example.com" target="_blank" rel="noopener noreferrer" className="projekty_text_link  projekty_text"><h5><i>Jesień z muzyką dawną</i><br/>II edycja</h5></a>
                </div>
        ...
        <div id="archiwalne_projekty">
          ...
          <div id="projekty_archiwalne_section">
            <div className="projekty_container_arc"><div className="projekty_item">
                <div className="projekty_photo" style={{
                backgroundImage: `url(${Jesienimg})`,
                }}><a href="https://example.com" target="_blank" rel="noopener noreferrer" className="projekty_text_link  projekty_text"><h5><i>Jesień z muzyką dawną</i><br/>II edycja</h5></a>
                </div>
